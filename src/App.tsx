...
function App() {
  return (
    ...
    <div id="anim">
    {/* <div
        style="width: 116px; height: 16px; position: relative; z-index: 70; margin-right: -116px; margin-bottom: -16px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -528px -304px; left: -118px; top: 0px;">
    </div>
    <div
        style="width: 16px; height: 16px; position: relative; z-index: 70; margin-right: -288px; margin-bottom: -16px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -288px -336px; left: -26px; top: 0px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -56px -320px; left: -50px; top: 0px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -112px -328px; left: 581.856px; top: 64px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -120px -320px; left: 547.524px; top: 13px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -72px -328px; left: -50px; top: 9px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -72px -320px; left: -50px; top: 9px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -112px -328px; left: 142.074px; top: 40px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -112px -320px; left: 1787.21px; top: 36px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -56px -328px; left: -50px; top: 0px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -120px -320px; left: 215.95px; top: 39px;">
    </div>
    <div
        style="width: 8px; height: 8px; position: relative; z-index: 70; margin-right: -8px; margin-bottom: -8px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -72px -328px; left: -50px; top: 9px;">
    </div>
    ...
    <div
        style="width: 16px; height: 24px; position: relative; z-index: 70; margin-right: -16px; margin-bottom: -24px; background: transparent url(&quot;/css/nesvbg_home.png&quot;) no-repeat scroll -176px -344px; left: -50px; top: 0px;">
    </div> */}
...
<div id="page">
    ...
    <table className="item" id="movie_2679_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px", verticalAlign:"top"}}>
                    <div id="movie_2679_1_image"><img title="" alt=""
                            src={require("./assets/images/2679M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_2679_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}} /><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_youtube.png")} alt="YouTube"
                            style={{cursor: "pointer"}}/></div>
                </td>
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Vault"><img title="Tier: Vault"
                            alt="[Tier: Vault]" src={require("./assets/images/vaulttier.png")} width="18"
                            height="18"/></a><span className="flagicons"><a
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                ...
                                height="18"/></a></span><span title="Movie #2679">Wii Anubis II</span><span
                        className="thin" title="Anubis 2 [RNVE5Z].wbfs"> (USA)</span> in 02:17.48 by CoolKirby.</th>
            </tr>
            <tr>
                <td style={{height:1+"%", verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/coolkirbyv1-anubis2.zip">Dolphin movie (.dtm)</a>
                    (date: 2014-08-30)<br></br><a
                        href="http://tracker.tasvideos.org/anubis2-tas-warpglitch-coolkirby.mkv.torrent">MKV file
                        via BitTorrent (Modern HQ)</a> (size: 9.16 MB, length: 02:33)<br></br><a
                        href="http://tracker.tasvideos.org/anubis2-tas-warpglitch-coolkirby_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 8.3 MB, length: 02:33)<br></br><a
                        id="movie_2679_1_stream_0"
                        href="http://archive.org/download/anubis2-tas-warpglitch-coolkirby/anubis2-tas-warpglitch-coolkirby.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_2679_1_stream_1"
                        href="http://archive.org/download/anubis2-tas-warpglitch-coolkirby/anubis2-tas-warpglitch-coolkirby_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_2679_1_stream_2"
                        href="http://www.youtube.com/watch?v=-MORAvx-S70" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/4392S.html" rel="nofollow">Submission
                        #4392</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/15650">Discuss this
                        movie</a><br></br>Rating: 3.8 <a href="http://tasvideos.org/rating.exe/2679/details">(12.5
                        votes)</a>
                {/*    <script type="text/javascript">function rateform_2679() {
                    ...
                    <br></br><a href="http://tasvideos.org/2679M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%", verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C3030Y.html">Uses death to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3035Y.html">Takes damage to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3041Y.html">Major skip glitch</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3042Y.html">Final boss skip glitch</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3055Y.html">Heavy glitch abuse</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style = {{verticalAlign:"top"}}><em>Anubis II</em> (read: "Anubis, the Second") is a
                    fast-paced platformer by Data Design Interactive, the creators of the infamous <em>Ninjabread
                        Man</em>. The evil spirit Mumm'hotep has plunged Egypt into darkness, and Anubis II, the
                    guardian of the tombs, sets out to stop him!
                    <p>But it seems that this quest is much easier than it appears. After
                        completely skipping going through the starting gate, Anubis decides to
                        play a bunch of minigames. This somehow causes his quest to become
                        completed. There was much rejoicing.
                    </p>
                </td>
            </tr>
            <tr>
                <td className="sharing" colSpan={2} style={{height:1 +"%"}}>
                    <table style={{width:100 + "%",height:1 +"%"}} >
                        <tbody>
                            <tr>
                                <td className="sharing" style={{width:100 + "%"}}></td>
                            </tr>
                        </tbody>
                    </table>
                    <hr className="invisiblehr"></hr>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <a id="M3466_1"></a>
    <table className="item" id="movie_3466_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px", verticalAlign:"top"}}>
                    <div id="movie_3466_1_image"><img title="" alt=""
                            src={require("./assets/images/3466M.jpg")} width="320" height="240"/><br></br>
                    </div>
                    <div id="movie_3466_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            alt="[Tier: Moons]" src={require("./assets/images/moontier.png")} width="18"
                            height="18"/></a><span className="flagicons"><a
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #3466">Wii Castlevania: The Adventure
                        ReBirth</span><span className="thin" title="Castlevania The Adventure ReBirth (U).wad">
                        (USA)</span> in 18:29.4 by <a href="http://tasvideos.org/Zggzdydp.html">zggzdydp</a>.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%", verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/zggzdydp-castlevaniatheadventurerebirth.zip">Dolphin
                        movie (.dtm)</a> (date: 2017-07-15)<br></br><a
                        href="http://tracker.tasvideos.org/castlevaniatheadventurerebirth-tas-zggzdydp.mkv.torrent">MKV
                        file via BitTorrent (Modern HQ)</a> (size: 175.39 MB, length: 20:57)<br></br><a
                        href="http://tracker.tasvideos.org/castlevaniatheadventurerebirth-tas-zggzdydp_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 174 MB, length: 20:57)<br></br><a
                        id="movie_3466_1_stream_0"
                        href="http://archive.org/download/castlevaniatheadventurerebirth-tas-zggzdydp/castlevaniatheadventurerebirth-tas-zggzdydp.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3466_1_stream_1"
                        href="http://archive.org/download/castlevaniatheadventurerebirth-tas-zggzdydp/castlevaniatheadventurerebirth-tas-zggzdydp_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3466_1_stream_2"
                        href="http://www.youtube.com/watch?v=1Z6vVOFkL8A" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/5572S.html" rel="nofollow">Submission
                        #5572</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/19315">Discuss this
                        movie</a><br></br>Rating: 7.5 <a href="http://tasvideos.org/rating.exe/3466/details">(7
                        votes)</a>
                   {/* <script type="text/javascript">function rateform_3466() {
                            var e = document.getElementById("rateform_3466");
                            e.innerHTML = '<form action="/rating.exe/my/3466" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3466M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%", verticalAlign:"top"}} className="misc">- <a
                        href="http://tasvideos.org/Movies-C3035Y.html">Takes damage to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C4005N.html">Uses hardest difficulty</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style ={{verticalAlign:"top"}}><em>Castlevania: The Adventure ReBirth</em> is a WiiWare
                    game that was released in 2009 by Konami. It is a remake of <a
                        title="[1612] GBC Konami GB Collection Vol. 1: Castlevania: The Adventure (Europe) by arukAdo in 14:58.7"
                        href="http://tasvideos.org/1612M.html">the Game Boy game</a>, starring Christopher Belmont,
                    seeking to defeat Dracula.
                    <p><a href="http://tasvideos.org/Zggzdydp.html">zggzdydp</a>, using various tricks, defeats
                        Count Dracula in record time.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("3466_1", false);
    </script>

    <a id="M2605_1"></a>
    <table className="item" id="movie_2605_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style= {{width:320+ "px", verticalAlign:"top"}}>
                    <div id="movie_2605_1_image"><img title="" alt=""
                            src={require("./assets/images/2605M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_2605_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Vault"><img title="Tier: Vault"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #2605">Wii Doc Louis's
                        Punch-Out!!</span><span className="thin" title="Doc Louis's Punch-Out!!.wad"> (USA)</span> in
                    01:40.15 by McHazard.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%",verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/mchazardv1-doclouispunchout.zip">Dolphin movie
                        (.dtm)</a> (date: 2014-05-25)<br></br><a
                        href="http://tracker.tasvideos.org/doclouispunchout-tas-mchazard.mkv.torrent">MKV file via
                        BitTorrent (Modern HQ)</a> (size: 17.94 MB, length: 02:24)<br></br><a
                        href="http://tracker.tasvideos.org/doclouispunchout-tas-mchazard_512kb.mp4.torrent">MP4 file
                        via BitTorrent (Compatibility)</a> (size: 19.49 MB, length: 02:25)<br></br><a
                        id="movie_2605_1_stream_0"
                        href="http://archive.org/download/MchazardsWiiDocLouissPunch-outIn0140.15/doclouispunchout-tas-mchazard.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_2605_1_stream_1"
                        href="http://archive.org/download/MchazardsWiiDocLouissPunch-outIn0140.15/doclouispunchout-tas-mchazard_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_2605_1_stream_2"
                        href="http://www.youtube.com/watch?v=wWjaV3VH94w" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/4306S.html" rel="nofollow">Submission
                        #4306</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/15330">Discuss this
                        movie</a><br></br>Rating: 6.8 <a href="http://tasvideos.org/rating.exe/2605/details">(10
                        votes)</a>
                 {/*    <script type="text/javascript">function rateform_2605() {
                            var e = document.getElementById("rateform_2605");
                            e.innerHTML = '<form action="/rating.exe/my/2605" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script>
                    */}
                    <br></br><a href="http://tasvideos.org/2605M.html">View Publication</a></td>
                <td style={{height:1+"%",width:30 + "%", verticalAlign:"top"}} className="misc">- <a
                        href="http://tasvideos.org/Movies-C1012Y.html">Aims for in-game time instead of
                        real-time</a><br></br>- <a href="http://tasvideos.org/Movies-C9010Y.html">Genre:
                        Fighting</a><br></br>- <a href="http://tasvideos.org/Movies-C9045Y.html">Genre: Sport</a><br></br>
                </td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style ={{verticalAlign:"top"}}><em>Doc Louis's Punch-Out!!</em> is a standalone title
                    released after the Wii remake of <em><a
                            title="[2488] NES Mike Tyson's Punch-Out!! (USA PRG1) by McHazard in 17:39.45"
                            href="http://tasvideos.org/2488M.html">Punch-Out!!</a></em> as a Platinum reward for
                    Club Nintendo members in North America. Taking place before the events of <em>Punch-Out!!</em>,
                    the game sees Little Mac spar with his coach, Doc Louis, through three
                    progressively difficult matches, which are each cleared by knocking him
                    down once.
                    <p>As with the other <em>Punch-Out!!</em> runs on this site, this run by McHazard aims for
                        in-game time first, then real time. The clock times achieved are listed below:
                    </p>
                    <p></p>
                    <pre>   Warm-up: 40.52
Training: 41.83
Sparring: 39.38
</pre>We also have a run of <em><a title="[2530] SNES Super Punch-Out!! (USA) by McHazard in 15:52.66"
                            href="http://tasvideos.org/2530M.html">Super Punch-Out!!</a></em> for the SNES.
                </td>
            </tr>
            <tr>
                <td className="sharing" colSpan={2} style={{height:1 + "%"}}>
    ...
    <script type="text/javascript">
        prepareStreaming("2605_1", false);
    </script>

    <a id="M3410_1"></a>
    <table className="item" id="movie_3410_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px", verticalAlign:"top"}}>
                    <div id="movie_3410_1_image"><img title="" alt=""
                            src={require("./assets/images/3410M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_3410_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1+ "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #3410">Wii GoldenEye: 007</span><span
                        className="thin" title="pm-goldeneye-007.iso"> (USA)</span> "007 classNameic difficulty" in
                    1:41:35.67 by FitterSpace.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%", verticalAlign:"top"}} className="misc"><a
                        href="http://tasvideos.org/movies/dtm/fitterspace-goldeneye007-007classNameic.zip">Dolphin movie
                        (.dtm)</a> (date: 2017-06-01)<br></br><a
                        href="http://tracker.tasvideos.org/goldeneye007-tas-007classNameic-fitterspace.mkv.torrent">MKV
                        file via BitTorrent (Modern HQ)</a> (size: 877.46 MB, length: 1:50:23)<br></br><a
                        href="http://tracker.tasvideos.org/goldeneye007-tas-007classNameic-fitterspace_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 893.13 MB, length: 1:50:23)<br></br><a
                        id="movie_3410_1_stream_0"
                        href="http://archive.org/download/goldeneye007-tas-007classNameic-fitterspace/goldeneye007-tas-007classNameic-fitterspace.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3410_1_stream_1"
                        href="http://archive.org/download/goldeneye007-tas-007classNameic-fitterspace/goldeneye007-tas-007classNameic-fitterspace_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3410_1_stream_2"
                        href="https://www.youtube.com/watch?v=zt3FeB7pQyM" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/5464S.html" rel="nofollow">Submission
                        #5464</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/19048">Discuss this
                        movie</a><br></br>Rating: 8.3 <a href="http://tasvideos.org/rating.exe/3410/details">(6
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_3410() {
                            var e = document.getElementById("rateform_3410");
                            e.innerHTML = '<form action="/rating.exe/my/3410" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3410M.html">View Publication</a></td>
                <td style={{height:1 + "%", width:30 + "%",verticalAlign:"top"}} className="misc">- <a
                        href="http://tasvideos.org/Movies-C4005N.html">Uses hardest difficulty</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9035Y.html">Genre: Shooter</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style = {{verticalAlign:"top"}}><em>Goldeneye: 007</em>
                    for the Nintendo Wii is a full-scale re-imagining of the N64 game, and
                    includes no assets from the original game. It takes the classNameic
                    Goldeneye story and updates it to the standards of a modern first-person
                    shooter. It also features Daniel Craig rather than Pierce Brosnan, who
                    played James Bond in the film and the Nintendo 64 game. It has many
                    modern features such as the ability to sprint and aim down sights.
                    <p>The missions in this game are based on the ones from the classNameic
                        Nintendo 64 version instead of the film. Some of the stages from the
                        original game have been combined in this game (for example, Bunker on
                        Wii is like Bunker+Silo on N64 and Cradle is like Control+Cradle on
                        N64). But there are also some brand-new missions like Nightclub and
                        Solar.
                    </p>
                    <p>This TAS plays on the hardest difficulty, 007 classNameic. Like the
                        original N64 game, the harder difficulties have more objectives than the
                        easier difficulties. This makes the route much more interesting because
                        the goal isn't simply to sprint to the end of the mission. 007 classNameic
                        also removes regenerating health, so there is much more health
                        management on this difficulty. Because a modern Call-of-Duty style FPS
                        game with no health regeneration would be unfair, the developers added
                        body armor that is only available on 007 classNameic, which the TAS makes
                        great use of.
                    </p>
                    <p>Since this game has roughly 35 minutes of unskippable cutscenes, the author provided a <a
                            className="extlink" rel="nofollow" id="i3709A14C_1"
                            href="http://www.youtube.com/watch?v=hAHJw0kh6Gg">condensed video</a> with all the
                        cutscenes and loading screens removed.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("3410_1", false);
    </script>

    <a id="M3140_1"></a>
    <table className="item" id="movie_3140_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 +"px", verticalAlign:"top"}}>
                    <div id="movie_3140_1_image"><img title="" alt=""
                            src={require("./assets/images/3140M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_3140_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Vault"><img title="Tier: Vault"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #3140">Wii Gummy Bears
                        Minigolf</span><span className="thin" title="SGYESZ.wbfs"> (USA)</span> in 12:27.13 by <a
                        href="http://tasvideos.org/Fog.html">Fog</a>.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%" , verticalAlign:"top"}} className="misc"><a
                        href="http://tasvideos.org/movies/dtm/fogv1-gummybearsminigolf.zip">Dolphin movie (.dtm)</a>
                    (date: 2016-05-21)<br></br><a
                        href="http://tracker.tasvideos.org/gummybearsminigolf-tas-fog.mkv.torrent">MKV file via
                        BitTorrent (Modern HQ)</a> (size: 90.02 MB, length: 14:36)<br></br><a
                        href="http://tracker.tasvideos.org/gummybearsminigolf-tas-fog_512kb.mp4.torrent">MP4 file
                        via BitTorrent (Compatibility)</a> (size: 94.97 MB, length: 14:36)<br></br><a
                        id="movie_3140_1_stream_0"
                        href="http://archive.org/download/gummybearsminigolf-tas-fog/gummybearsminigolf-tas-fog_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3140_1_stream_1"
                        href="http://archive.org/download/gummybearsminigolf-tas-fog/gummybearsminigolf-tas-fog.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3140_1_stream_2"
                        href="https://www.youtube.com/watch?v=7RH8xlY4hr8" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/5087S.html" rel="nofollow">Submission
                        #5087</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/17886">Discuss this
                        movie</a><br></br>Rating: 4.8 <a href="http://tasvideos.org/rating.exe/3140/details">(8
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_3140() {
                            var e = document.getElementById("rateform_3140");
                            e.innerHTML = '<form action="/rating.exe/my/3140" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3140M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%", verticalAlign:"top"}} className="misc">- <a
                        href="http://tasvideos.org/Movies-C9045Y.html">Genre: Sport</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style={{verticalAlign:"top"}}><em>Gummy Bears Minigolf</em>,
                    released in September 2010, is a licensed mini-golf game for the
                    Nintendo Wii. You can play as one of eight different colored Gummy
                    Bears, with four colorful mini-golf courses to choose from.
                    <p>Originally submitting this as an April Fool's joke, <a
                            href="http://tasvideos.org/Fog.html">Fog</a>
                        daringly went where few people had gone before by playing through this
                        awful game. He abuses the game's poor physics whenever possible to
                        finish every hole in the four mini-golf courses as fast as possible.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("3140_1", false);
    </script>

    <a id="M2969_1"></a>
    <table className="item" id="movie_2969_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px",verticalAlign:"top"}}>
                    <div id="movie_2969_1_image"><img title="" alt=""
                            src={require("./assets/images/2969M.png")} width="320" height="240"/><br></br>
                    </div>
                    <div id="movie_2969_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1+ "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #2969">Wii Mega Man 9</span><span
                        className="thin" title="Mega Man 9 NTSC-U.wad"> (USA)</span> in 30:20.98 by AngerFist &amp;
                    diggidoyo.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%", verticalAlign:"top"}} className="misc"><a
                        href="http://tasvideos.org/movies/dtm/angerfist%2Cdiggidoyo-megaman9.zip">Dolphin movie
                        (.dtm)</a> (date: 2015-10-02)<br></br><a
                        href="http://tracker.tasvideos.org/megaman9-tas-angerfist,diggidoyo.mkv.torrent">MKV file
                        via BitTorrent (Modern HQ)</a> (size: 90.04 MB, length: 34:10)<br></br><a
                        href="http://tracker.tasvideos.org/megaman9-tas-angerfist,diggidoyo_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 90.44 MB, length: 34:10)<br></br><a
                        id="movie_2969_1_stream_0"
                        href="http://archive.org/download/Megaman9-tas-angerfistdiggidoyo/megaman9-tas-angerfist,diggidoyo.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_2969_1_stream_1"
                        href="http://archive.org/download/Megaman9-tas-angerfistdiggidoyo/megaman9-tas-angerfist,diggidoyo_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_2969_1_stream_2"
                        href="http://www.youtube.com/watch?v=WlzlgTRgcc4" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/4848S.html" rel="nofollow">Submission
                        #4848</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/17198">Discuss this
                        movie</a><br></br>Rating: 8.6 <a href="http://tasvideos.org/rating.exe/2969/details">(13
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_2969() {
                            var e = document.getElementById("rateform_2969");
                            e.innerHTML = '<form action="/rating.exe/my/2969" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/2969M.html">View Publication</a></td>
                <td style={{height:1 + "%" ,width:30+ "%", verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C3035Y.html">Takes damage to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br><a
                        href="http://tasvideos.org/Awards/2015.html#tas_first_15"><img
                            src="TASVideos%20movies%20Wii%20only_files/tas_first_15.png"
                            alt="Award - First edition TAS of 2015" title="Award - First edition TAS of 2015"
                            style={{border:"none", height:40 +"px"}}/></a></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style = {{verticalAlign:"top"}}><em>Mega Man 9</em>, known in Japan as <em>Rockman 9: Yabō
                        no Fukkatsu!!</em>
                    (ロックマン9 野望の復活!!) is a video game made by Capcom and Inti Creates for
                    the WiiWare download service, among others, in 2008. This game is
                    notable in that despite being developed for modern consoles, it features
                    8-bit visuals and audio as a retro throwback to the NES entries of the
                    series. It also features a plot twist early on in that Dr. Light's
                    robots go on a rampage, with Dr. Wily not having any connection to the
                    incident (or so he claims).
                    <p><a href="http://tasvideos.org/AngerFist.html">AngerFist</a> and diggidoyo blaze through the
                        game and defeat Dr. Wily once again in 30 minutes and 20.98 seconds (19:11 in-game time).
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("2969_1", false);
    </script>

    <a id="M2005_1"></a>
    <table className="item" id="movie_2005_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px" ,verticalAlign:"top"}}>
                    <div id="movie_2005_1_image"><img title="Bass hitches a ride" alt=""
                            src={require("./assets/images/2005M.png")} width="256" height="224"/><br></br>
                    </div>
                    <div id="movie_2005_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_youtube.png")} alt="YouTube"
                            style={{cursor: "pointer"}}/></div>
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            alt="[Tier: Moons]" src={require("./assets/images/moontier.png")} width="18"
                            height="18"/></a><span title="Movie #2005">Wii Mega Man 10</span><span className="thin"
                        title="Mega Man 10 NTSC-U.wad"> (USA)</span> "Bass, Hard Mode" in 28:18.25 by diggidoyo.
                </th>
            </tr>
            <tr>
                <td style={{height:1 + "%",verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/diggidoyo-megaman10-bass.zip">Dolphin movie (.dtm)</a>
                    (date: 2012-03-25)<br></br><a
                        href="http://tracker.tasvideos.org/megaman10-tas-bass-diggidoyo.mkv.torrent">MKV file via
                        BitTorrent</a> (size: 44.33 MB, length: 34:09)<br></br><a
                        href="http://tracker.tasvideos.org/megaman10-tas-bass-diggidoyo_10bit444.mkv.torrent">MKV
                        file via BitTorrent (Modern HQ)</a> (size: 56.14 MB, length: 34:09)<br></br><a
                        id="movie_2005_1_stream_0"
                        href="http://archive.org/download/WiiMegaMan10usabassIn2818.25ByDiggidoyo/megaman10-tas-bass-diggidoyo.mkv"
                        rel="nofollow">Mirror archive.org</a><br></br><a id=""
                        href="http://archive.org/download/WiiMegaMan10usabassIn2818.25ByDiggidoyo/megaman10-tas-bass-diggidoyo_10bit444.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_2005_1_stream_1"
                        href="http://www.youtube.com/watch?v=poxUFFOeZl4" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/3373S.html" rel="nofollow">Submission
                        #3373</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/12083">Discuss this
                        movie</a><br></br>Rating: 8.4 <a href="http://tasvideos.org/rating.exe/2005/details">(24
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_2005() {
                            var e = document.getElementById("rateform_2005");
                            e.innerHTML = '<form action="/rating.exe/my/2005" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/2005M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%", verticalAlign: "top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C3035Y.html">Takes damage to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C4005N.html">Uses hardest difficulty</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C4010Y.html">Second quest/Post game-completion</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C4015Y.html">Starts from a saved state or SRAM</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style ={{verticalAlign:"top"}}>Not wanting to be outdone by Mega Man, Bass takes a shot
                    at saving the world from Roboenza. Dr. Wily won't know what hit him.
                    <p>This is the site's second published Wii run, and is of the same game as the <a
                            title="[1812] Wii Mega Man 10 (USA) &quot;Mega Man&quot; by diggidoyo in 33:42.37"
                            href="http://tasvideos.org/1812M.html">first</a>. Diggidoyo again shows his expertise at
                        the Mega Man series, this time utilizing Bass's speed and powerful weaponry to finish <abbr
                            title="19,447 Frames @60 FPS">5:24.11</abbr> faster than Mega Man.
                    </p>
                    <p>The in-game completion time reads <b>15:16</b>.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("2005_1", false);
    </script>

    <a id="M1812_1"></a>
    <table className="item" id="movie_1812_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px",  verticalAlign:"top"}}>
                    <div id="movie_1812_1_image"><img title="Mega Man shoots enemies for item drops" alt=""
                            src={require("./assets/images/1812M.png")} width="256" height="224"/><br></br>
                    </div>
                    <div id="movie_1812_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 +"%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            alt="[Tier: Moons]" src={require("./assets/images/moontier.png")} width="18"
                            height="18"/></a><span title="Movie #1812">Wii Mega Man 10</span><span className="thin"
                        title="Mega Man 10 NTSC-U.wad"> (USA)</span> "Mega Man" in 33:42.37 by diggidoyo.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%", verticalAlign: "top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/diggidoyo-megaman10-megaman.zip">Dolphin movie
                        (.dtm)</a> (date: 2011-05-28)<br></br><a
                        href="http://tracker.tasvideos.org/megaman10-tas-megaman-diggidoyo.mkv.torrent">MKV file via
                        BitTorrent (Modern HQ)</a> (size: 55.83 MB, length: 39:31)<br></br><a
                        href="http://tracker.tasvideos.org/megaman10-tas-megaman-diggidoyo_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 82.4 MB, length: 39:31)<br></br><a
                        id="movie_1812_1_stream_0"
                        href="http://archive.org/download/WiiMegaMan10megaManByDiggidoyoIn3342.37/megaman10-tas-megaman-diggidoyo.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_1812_1_stream_1"
                        href="http://archive.org/download/WiiMegaMan10megaManByDiggidoyoIn3342.37/megaman10-tas-megaman-diggidoyo_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_1812_1_stream_2"
                        href="https://www.youtube.com/watch?v=uqNmr2h5ef0" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/3157S.html" rel="nofollow">Submission
                        #3157</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/11258">Discuss this
                        movie</a><br></br>Rating: 8.5 <a href="http://tasvideos.org/rating.exe/1812/details">(46
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_1812() {
                            var e = document.getElementById("rateform_1812");
                            e.innerHTML = '<form action="/rating.exe/my/1812" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/1812M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%", verticalAlign :"top"}} className="misc">- <a
                        href="http://tasvideos.org/Movies-C3025Y.html">Uses a suboptimal character</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3060Y.html">Heavy luck manipulation</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style = {{verticalAlign:"top"}}>Watch
                    as Mega Man takes on the latest set of Robot Masters and everyone's
                    favorite mad roboticist for the tenth time in the classNameic series.
                    <p>This run is played on normal difficulty (the highest available with
                        no prior save data) and, amongst other feats, takes no damage at all
                        (Mr. Perfect achievement), kills one of every enemy (World Warrior
                        achievement), and manipulates more extra lives and large power-ups than
                        you've probably ever seen before in a single playthrough. The final
                        in-game time is 20:04.
                    </p>
                    <p>In a fit of cosmic irony, this publication, which is the first
                        for a current set-top console, is of a game deliberately designed to be a
                        throwback to the NES days.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("1812_1", false);
    </script>

    <a id="M3288_1"></a>
    <table className="item" id="movie_3288_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px",  verticalAlign:"top"}}>
                    <div id="movie_3288_1_image"><img title="" alt=""
                            src={require("./assets/images/3288M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_3288_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #3288">Wii Muramasa: The Demon
                        Blade</span><span className="thin" title="Muramasa - The Demon Blade (U).iso"> (USA)</span>
                    "Momohime" in 1:03:44.55 by Hetfield90 &amp; RachelB.</th>
            </tr>
            <tr>
                <td style={{height:1+ "%", verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/hetfield90rachelbv2-muramasa.zip">Dolphin movie
                        (.dtm)</a> (date: 2016-12-23)<br></br><a
                        href="http://tracker.tasvideos.org/muramasa-tas-momohime-hetfield90,rachelb.mkv.torrent">MKV
                        file via BitTorrent (Modern HQ)</a> (size: 1.09 GB, length: 1:10:25)<br></br><a
                        href="http://tracker.tasvideos.org/muramasa-tas-momohime-hetfield90,rachelb_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 1.17 GB, length: 1:10:25)<br></br><a
                        id="movie_3288_1_stream_0"
                        href="http://archive.org/download/Muramasa-tas-momohime-hetfield90rachelb_fixed/muramasa-tas-momohime-hetfield90,rachelb.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3288_1_stream_1"
                        href="http://archive.org/download/Muramasa-tas-momohime-hetfield90_rachelb/muramasa-tas-momohime-hetfield90%2crachelb_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3288_1_stream_2"
                        href="https://www.youtube.com/watch?v=MHnFuMrWqnM" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/5286S.html" rel="nofollow">Submission
                        #5286</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/18562">Discuss this
                        movie</a><br></br><a href="http://tasvideos.org/2009M.html"
                        title="[2009] Wii Muramasa: The Demon Blade (USA) &quot;Momohime&quot; by RachelB in 1:04:59.75"
                        rel="nofollow">Obsoletes movie #2009</a> (1:04:59.75)<br></br>Rating: 7.2 <a
                        href="http://tasvideos.org/rating.exe/3288/details">(6 votes)</a>
                    {/* <script type="text/javascript">function rateform_3288() {
                            var e = document.getElementById("rateform_3288");
                            e.innerHTML = '<form action="/rating.exe/my/3288" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3288M.html">View Publication</a></td>
                <td style={{height:1 + "%", width:30 + "%", verticalAlign:"top" }} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C3035Y.html">Takes damage to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3060Y.html">Heavy luck manipulation</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C4015Y.html">Starts from a saved state or SRAM</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9005Y.html">Genre: Adventure</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style = {{verticalAlign:"top"}}><em>Muramasa: The Demon Blade</em>
                    is a trip through 16th century Japan with cool music, beautiful visuals
                    and fast paced gameplay. Watch as the authors introduce you to
                    Momohime, a young princess possessed by an evil spirit who proves quite
                    adept at cutting everything in her path into tiny bits. As opposed to
                    the <a
                        title="[2009] Wii Muramasa: The Demon Blade (USA) &quot;Momohime&quot; by RachelB in 1:04:59.75"
                        href="http://tasvideos.org/2009M.html">previous run</a>
                    this one no longer plays on post-completion Shiguri difficulty, saving
                    nine seconds by avoiding the intro sequence that comes with it.
                    <p>A run of Muramasa's second character Kisuke is available here: <a
                            href="http://tasvideos.org/3248M.html">[3248] Wii Muramasa: The Demon Blade (JPN)
                            "Kisuke" by Bernka in 1:03:49.15</a>
                    </p>
                    <p>Note: There are <a href="http://tasvideos.org/forum/p/459659#459659">encodes of higher
                            resolution</a> in the discussion thread.
                    </p>
                </td>
            </tr>
            <tr>
                <td className="sharing" style={{height:1+"%"}}>
                    <table style={{width:100+"%",height:1+"%"}}>
                        <tbody>
                            <tr>
                                <td className="sharing" style={{width:100+"%"}}></td>
    ...
    <script type="text/javascript">
        prepareStreaming("3288_1", false);
    </script>

    <a id="M3248_1"></a>
    <table className="item" id="movie_3248_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px", verticalAlign:"top"}}>
                    <div id="movie_3248_1_image"><img title="" alt=""
                            src={require("./assets/images/3248M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_3248_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            alt="[Tier: Moons]" src={require("./assets/images/moontier.png")} width="18"
                            height="18"/></a><span title="Movie #3248">Wii Muramasa: The Demon Blade</span><span
                        className="thin" title="RSFJ99_OBORO MURAMASA (J).iso"> (JPN)</span> "Kisuke" in 1:03:49.15 by
                    Bernka.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%", verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/bernkav1-muramasathedemonblade.zip">Dolphin movie
                        (.dtm)</a> (date: 2016-10-30)<br></br><a
                        href="http://tracker.tasvideos.org/muramasathedemonblade-tas-kisuke-bernka.mkv.torrent">MKV
                        file via BitTorrent (Modern HQ)</a> (size: 1.1 GB, length: 1:10:17)<br></br><a
                        href="http://tracker.tasvideos.org/muramasathedemonblade-tas-kisuke-bernka_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 1.16 GB, length: 1:10:17)<br></br><a
                        id="movie_3248_1_stream_0"
                        href="http://archive.org/download/muramasathedemonblade-tas-kisuke-bernka/muramasathedemonblade-tas-kisuke-bernka.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3248_1_stream_1"
                        href="http://archive.org/download/muramasathedemonblade-tas-kisuke-bernka/muramasathedemonblade-tas-kisuke-bernka_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3248_1_stream_2"
                        href="https://www.youtube.com/watch?v=pGtxzHWBZro" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/5179S.html" rel="nofollow">Submission
                        #5179</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/18212">Discuss this
                        movie</a><br></br>Rating: 7.4 <a href="http://tasvideos.org/rating.exe/3248/details">(5
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_3248() {
                            var e = document.getElementById("rateform_3248");
                            e.innerHTML = '<form action="/rating.exe/my/3248" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3248M.html">View Publication</a></td>
                <td style={{height:1+ "%", width:30 + "%", verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C4005N.html">Uses hardest difficulty</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C4015Y.html">Starts from a saved state or SRAM</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9005Y.html">Genre: Adventure</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9010Y.html">Genre: Fighting</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9030Y.html">Genre: RPG</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style ={{verticalAlign:"top"}}>Set in Japanese Edo period's Honshu <em>Oboro
                        Muramasa</em>
                    revolves around fast-paced spectacle fighting with RPG elements against
                    vicious demons summoned by the titular Demon Blades. Two characters are
                    available. Here, Bernka plays the amnesiac ninja Kisuke on highest
                    difficulty, by way of which he gets granted only one hitpoint. Of
                    course, this doesn't intimidate him in the slightest.
                    <p>Don't forget to watch its sister movie showing off Momohime as well: <a
                            href="http://tasvideos.org/2009M.html">[2009] Wii Muramasa: The Demon Blade (USA)
                            "Momohime" by RachelB in 1:04:59.75</a>
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("3248_1", false);
    </script>

    <a id="M4195_1"></a>
    <table className="item" id="movie_4195_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320+ "px", verticalAlign:"top"}}>
                    <div id="movie_4195_1_image"><img title="Pac-Man jumps past a barrier." alt=""
                            src={require("./assets/images/4195M.jpg")} width="320" height="196"/><br></br>
                    </div>
                    <div id="movie_4195_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #4195">Wii Namco Museum
                        Megamix</span><span className="thin" title="Namco Museum Megamix (USA).wbfs"> (USA)</span>
                    "Pac'n Roll Remix" in 15:21.02 by Elomavi.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%", verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/elomavi-namcomuseummegamix-pacnrollremix.zip">Dolphin
                        movie (.dtm)</a> (date: 2020-05-28)<br></br><a
                        href="http://tracker.tasvideos.org/namcomuseummegamix-tas-pacnrollremix-elomavi.mkv.torrent">MKV
                        file via BitTorrent (Modern HQ)</a> (size: 285.24 MB, length: 16:48)<br></br><a
                        href="http://tracker.tasvideos.org/namcomuseummegamix-tas-pacnrollremix-elomavi_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 292.83 MB, length: 16:48)<br></br><a
                        id="movie_4195_1_stream_0"
                        href="http://archive.org/download/namcomuseummegamix-tas-pacnrollremix-elomavi/namcomuseummegamix-tas-pacnrollremix-elomavi.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_4195_1_stream_1"
                        href="http://archive.org/download/namcomuseummegamix-tas-pacnrollremix-elomavi/namcomuseummegamix-tas-pacnrollremix-elomavi_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_4195_1_stream_2"
                        href="http://www.youtube.com/watch?v=lX3SsyZDt3E" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/6627S.html" rel="nofollow">Submission
                        #6627</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/21618">Discuss this
                        movie</a><br></br>Rating: 8.2 <a href="http://tasvideos.org/rating.exe/4195/details">(3
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_4195() {
                            var e = document.getElementById("rateform_4195");
                            e.innerHTML = '<form action="/rating.exe/my/4195" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/4195M.html">View Publication</a></td>
                <td style={{height:1 + "%", width:30+ "%", verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C3030Y.html">Uses death to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3035Y.html">Takes damage to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            ...
            <tr>
                <td colSpan={2} className="blah" style={{verticalAlign:"top"}}><em>Namco Museum Megamix</em> is a compilation of Namco
                    arcade games that also includes six "remix" games. In <em>Pac'n Roll Remix</em>, the player
                    guides Pac-Man on a quest through five worlds in order to save Pac-Land from the evil ghost
                    Golvis.
                    <p>Elomavi completes <em>Pac'n Roll Remix</em> in record time by using precise movement, speed
                        boosts, and glitches. See the <a
                            title="#6627: Elomavi's Wii Namco Museum Megamix &quot;Pac'n Roll Remix&quot;  in 15:21.02"
                            href="http://tasvideos.org/6627S.html">submission notes</a> for details.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("4195_1", false);
    </script>

    <a id="M3754_1"></a>
    <table className="item" id="movie_3754_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 +"px" , verticalAlign:"top"}}>
                    <div id="movie_3754_1_image"><img title="" alt=""
                            src={require("./assets/images/3754M.png")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_3754_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            alt="[Tier: Moons]" src={require("./assets/images/moontier.png")} width="18"
                            height="18"/></a><span title="Movie #3754">Wii New Super Mario Bros. Wii</span><span
                        className="thin" title="1752 - New Super Mario Bros. Wii NTSC-U.iso"> (USA)</span> "100%" in
                    2:58:33.27 by Soig.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%", verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/soig-nsmbwii-100p.zip">Dolphin movie (.dtm)</a> (date:
                    2018-08-02)<br></br><a href="http://tracker.tasvideos.org/nsmbwii-tas-100p-soig.mkv.torrent">MKV file
                        via BitTorrent (Modern HQ)</a> (size: 1.52 GB, length: 2:58:59)<br></br><a
                        href="http://tracker.tasvideos.org/nsmbwii-tas-100p-soig_512kb.mp4.torrent">MP4 file via
                        BitTorrent (Compatibility)</a> (size: 1.7 GB, length: 2:58:59)<br></br><a
                        id="movie_3754_1_stream_0"
                        href="http://archive.org/download/nsmbwii-tas-100p-soig/nsmbwii-tas-100p-soig.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3754_1_stream_1"
                        href="http://archive.org/download/nsmbwii-tas-100p-soig/nsmbwii-tas-100p-soig_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3754_1_stream_2"
                        href="https://www.youtube.com/watch?v=pn0XyR89ks0" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/5958S.html" rel="nofollow">Submission
                        #5958</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/20173">Discuss this
                        movie</a><br></br>Rating: 8.2 <a href="http://tasvideos.org/rating.exe/3754/details">(9
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_3754() {
                            var e = document.getElementById("rateform_3754");
                            e.innerHTML = '<form action="/rating.exe/my/3754" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3754M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%", verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C2000Y.html">100% completion</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3035Y.html">Takes damage to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style= {{verticalAlign:"top"}}><em>New Super Mario Bros. Wii</em> is a 2009
                    side-scrolling platform video game developed and published by Nintendo for the Wii video game
                    console. <em>New Super Mario Bros. Wii</em>
                    follows Mario as he fights his way through Bowser's henchmen to rescue
                    Princess Peach. Mario has access to several power-ups that help him
                    complete his quest, including the Ice Flower, the Fire Flower, and the
                    Starman, each giving him unique abilities. There are some new powerups
                    to this game, such as the Propeller Hat which lets the player ascend
                    very quickly.
                    <p>Here, author Soig manages to "complete everything in <em>New Super Mario Bros. Wii</em>" in
                        under 3 hours.
                    </p>
                </td>
            </tr>
    ...
    <script type="text/javascript">
        prepareStreaming("3754_1", false);
    </script>

    <a id="M4247_1"></a>
    <table className="item" id="movie_4247_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px", verticalAlign:"top"}}>
                    <div id="movie_4247_1_image"><img title="" alt=""
                            src={require("./assets/images/4247M.jpg")} width="320" height="180"/><br></br>
                    </div>
                    <div id="movie_4247_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #4247">Wii New Super Mario Bros.
                        Wii</span><span className="thin"> (JPN)</span> "warps" in 24:54.8 by Monster.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%", verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/monsterv2-nsmbwii-warps.zip">Dolphin movie (.dtm)</a>
                    (date: 2020-07-22)<br></br><a
                        href="http://tracker.tasvideos.org/nsmbwii-tasv2-warps-monster.mkv.torrent">MKV file via
                        BitTorrent (Modern HQ)</a> (size: 237.1 MB, length: 31:06)<br></br><a
                        href="http://tracker.tasvideos.org/nsmbwii-tasv2-warps-monster_512kb.mp4.torrent">MP4 file
                        via BitTorrent (Compatibility)</a> (size: 244.36 MB, length: 31:06)<br></br><a
                        id="movie_4247_1_stream_0"
                        href="http://archive.org/download/nsmbwii-tasv2-warps-monster/nsmbwii-tasv2-warps-monster.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_4247_1_stream_1"
                        href="http://archive.org/download/nsmbwii-tasv2-warps-monster/nsmbwii-tasv2-warps-monster_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_4247_1_stream_2"
                        href="https://www.youtube.com/watch?v=CuA6PmU8GJQ" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/6766S.html" rel="nofollow">Submission
                        #6766</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/21910">Discuss this
                        movie</a><br></br><a href="http://tasvideos.org/3643M.html"
                        title="[3643] Wii New Super Mario Bros. Wii (JPN) &quot;warps&quot; by Monster in 25:02.1"
                        rel="nofollow">Obsoletes movie #3643</a> (25:02.1)<br></br>Rating: 8.2 <a
                        href="http://tasvideos.org/rating.exe/4247/details">(4 votes)</a>
                    {/* <script type="text/javascript">function rateform_4247() {
                            var e = document.getElementById("rateform_4247");
                            e.innerHTML = '<form action="/rating.exe/my/4247" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/4247M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%", verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C3040Y.html">Uses warps</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style = {{verticalAlign:"top"}}><em>New Super Mario Bros. Wii</em> is a 2009
                    ...
                    to this game, such as the Propeller Hat which lets the player ascend
                    very quickly.
                    <p>Monster improves upon the <a
                            title="[3643] Wii New Super Mario Bros. Wii (JPN) &quot;warps&quot; by Monster in 25:02.1"
                            href="http://tasvideos.org/3643M.html">previous publication</a> by 7.29 seconds.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("4247_1", false);
    </script>

    <a id="M2408_1"></a>
    <table className="item" id="movie_2408_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px",verticalAlign:"top"}}>
                    <div id="movie_2408_1_image"><img title="" alt=""
                            src={require("./assets/images/2408M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_2408_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_youtube.png")} alt="YouTube"
                            style={{cursor: "pointer"}}/></div>
                ...
                <th style={{height:1+ "%"}} colSpan={2}><a href="http://tasvideos.org/Vault"><img title="Tier: Vault"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #2408">Wii Pucca's Kisses Game</span><span
                        className="thin" title="Pucca's Kisses Game NTSC-U.wad"> (USA)</span> in 46:09.37 by RachelB.
                </th>
            </tr>
            <tr>
                <td style={{height:1+ "%", verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/rachelb1-puccaskisses.zip">Dolphin movie (.dtm)</a>
                    (date: 2013-06-26)<br></br><a
                        href="http://tracker.tasvideos.org/puccaskisses-tas-rachelb.mkv.torrent">MKV file via
                        BitTorrent</a> (size: 338.62 MB, length: 48:49)<br></br><a
                        href="http://tracker.tasvideos.org/puccaskisses-tas-rachelb_10bit444.mkv.torrent">MKV file
                        via BitTorrent (Modern HQ)</a> (size: 297.97 MB, length: 48:49)<br></br><a
                        id="movie_2408_1_stream_0"
                        href="http://archive.org/download/PuccaskissesTasRachelb/puccaskisses-tas-rachelb.mkv"
                        rel="nofollow">Mirror archive.org</a><br></br><a id=""
                        href="http://archive.org/download/PuccaskissesTasRachelb/puccaskisses-tas-rachelb_10bit444.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_2408_1_stream_1"
                        href="http://www.youtube.com/watch?v=E7WcrY5vNTM" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/3985S.html" rel="nofollow">Submission
                        #3985</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/14158">Discuss this
                        movie</a><br></br>Rating: 5.8 <a href="http://tasvideos.org/rating.exe/2408/details">(12
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_2408() {
                            var e = document.getElementById("rateform_2408");
                            e.innerHTML = '<form action="/rating.exe/my/2408" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/2408M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%",verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C9015Y.html">Genre: Platform</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style={{verticalAlign:"top"}}><em>Pucca's Kisses Game</em>
                    is a cute little WiiWare title starring the popular Pucca, who's on a
                    journey across dangerous areas to catch and kiss her crush, Garu.
                    <p>While this is a fairly simple game, RachelB still employs some
                        extremely precise tricks, such as wrapping the Wii Remote across the
                        screen in one frame, to help beat it in the fastest time possible.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("2408_1", false);
    </script>

    <a id="M3338_1"></a>
    <table className="item" id="movie_3338_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px", verticalAlign:"top"}}>
                    <div id="movie_3338_1_image"><img title="" alt=""
                            src={require("./assets/images/3338M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_3338_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #3338">Wii Rayman Origins</span><span
                        className="thin" title="Rayman Origins USA.iso"> (USA)</span> in 45:31.3 by keylie.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%",verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/keylie-raymanorigins.zip">Dolphin movie (.dtm)</a>
                    (date: 2017-02-24)<br></br><a
                        href="http://tracker.tasvideos.org/raymanorigins-tas-keylie.mkv.torrent">MKV file via
                        BitTorrent (Modern HQ)</a> (size: 458.97 MB, length: 1:02:56)<br></br><a
                        href="http://tracker.tasvideos.org/raymanorigins-tas-keylie_512kb.mp4.torrent">MP4 file via
                        BitTorrent (Compatibility)</a> (size: 505.99 MB, length: 1:02:56)<br></br><a
                        id="movie_3338_1_stream_0"
                        href="http://archive.org/download/raymanorigins-tas-keylie/raymanorigins-tas-keylie.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3338_1_stream_1"
                        href="http://archive.org/download/raymanorigins-tas-keylie/raymanorigins-tas-keylie_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3338_1_stream_2"
                        href="http://www.youtube.com/watch?v=uj_GnHZlDvE" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/5370S.html" rel="nofollow">Submission
                        #5370</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/18809">Discuss this
                        movie</a><br></br>Rating: 7.4 <a href="http://tasvideos.org/rating.exe/3338/details">(7
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_3338() {
                            var e = document.getElementById("rateform_3338");
                            e.innerHTML = '<form action="/rating.exe/my/3338" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3338M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%",verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C3020Y.html">4 Players</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3030Y.html">Uses death to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3035Y.html">Takes damage to save time</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C3041Y.html">Major skip glitch</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
            ...
            <tr>
                <td colSpan={2} className="blah" style={{verticalAlign:"top"}}><em>Rayman Origins</em>
                    features the return of the Rayman character in a 2D platformer. Many of
                    the original Rayman game's characters and enemies make an appearance,
                    like Livingstones, Electoons, Betilla and the Magician's hat. There are
                    also various characters from Rayman 2 such as Globox, the Teensies and
                    Lums. The game's atmosphere, however, is different from the original
                    Rayman game and has a very "wacky" feel instead. The main objective of
                    each level is to rescue as many Electoons as possible similarly to the
                    original game.
                    <p>keylie, as 4 players, collects the minimum Electoons required to reach the Magician and
                        defeat him in record time.
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <script type="text/javascript">
        prepareStreaming("3338_1", false);
    </script>

    <a id="M3794_1"></a>
    <table className="item" id="movie_3794_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320+ "px",verticalAlign:"top"}}>
                    <div id="movie_3794_1_image"><img title="" alt=""
                            src={require("./assets/images/3794M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_3794_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #3794">Wii The Conduit</span><span
                        className="thin" title="The Conduit (USA)"> (USA)</span> in 45:46.7 by NEVERDOORS.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%",verticalAlign:"top"}} className="misc"><a
                        href="http://tasvideos.org/movies/dtm/neverdoors-theconduit.zip">Dolphin movie (.dtm)</a>
                    (date: 2018-09-25)<br></br><a
                        href="http://tracker.tasvideos.org/theconduit-tas-neverdoors.mkv.torrent">MKV file via
                        BitTorrent (Modern HQ)</a> (size: 681.25 MB, length: 49:18)<br></br><a
                        href="http://tracker.tasvideos.org/theconduit-tas-neverdoors_512kb.mp4.torrent">MP4 file via
                        BitTorrent (Compatibility)</a> (size: 649.82 MB, length: 49:18)<br></br><a
                        id="movie_3794_1_stream_0"
                        href="http://archive.org/download/theconduit-tas-neverdoors/theconduit-tas-neverdoors.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3794_1_stream_1"
                        href="http://archive.org/download/theconduit-tas-neverdoors/theconduit-tas-neverdoors_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3794_1_stream_2"
                        href="http://www.youtube.com/watch?v=zv7h8-HZH_E" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/6007S.html" rel="nofollow">Submission
                        #6007</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/20263">Discuss this
                        movie</a><br></br>Rating: 8.0 <a href="http://tasvideos.org/rating.exe/3794/details">(4
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_3794() {
                            var e = document.getElementById("rateform_3794");
                            e.innerHTML = '<form action="/rating.exe/my/3794" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3794M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30 + "%",verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C3055Y.html">Heavy glitch abuse</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9000Y.html">Genre: Action</a><br></br>- <a
                        href="http://tasvideos.org/Movies-C9035Y.html">Genre: Shooter</a><br></br></td>
            ...
            <tr>
                <td colSpan={2} className="blah" style= {{verticalAlign:"top"}}>Aliens meet the Illuminati is basically the plot of
                    <em>The Conduit</em>,
                    a First Person Shooter exclusive to the Wii. The game was made in
                    response to the relative lack of more "hardcore" titles for the console
                    at the time. In this title, one plays as Michael Ford fighting against
                    the Trust, a mysterious organization trying to control America, and the
                    Drudge, a race of alien invaders working with the Trust. The player is
                    able to use a variety of weapon types to fight off attackers and makes
                    use of an artifact called the All Seeing Eye to solve puzzles.
                    <p>In this TAS, NEVERDOORS uses absurd aim, out of bounds, and other
                        glitches to finish the game in under 46 minutes, and in 40:08 ingame
                        time.
                    </p>
                   
                    Note: There are also lossless encodes and encodes at additional resolutions available in the <a
                        href="http://tasvideos.org/forum/p/475135#475135">discussion thread</a>.
    ...
    <script type="text/javascript">
        prepareStreaming("3794_1", false);
    </script>

    <a id="M3890_1"></a>
    <table className="item" id="movie_3890_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 +"px",verticalAlign:"top"}}>
                    <div id="movie_3890_1_image"><img title="" alt=""
                            src={require("./assets/images/3890M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_3890_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                ...
                <th style={{height:1 + "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            alt="[Tier: Moons]" src={require("./assets/images/moontier.png")} width="18"
                            height="18"/></a><span title="Movie #3890">Wii Wii Sports</span><span className="thin"
                        title="Wii Sports [RSPE01].wbfs"> (USA)</span> "Golf, 9-Hole Game" in 03:33.4 by tendog.
                </th>
            </tr>
            <tr>
                <td style={{height:1 + "%",verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/tendog-wiisports-golf%2C9holegame.zip">Dolphin movie
                        (.dtm)</a> (date: 2019-01-19)<br></br><a
                        href="http://tracker.tasvideos.org/wiisports-tas-golf,9holegame-tendog.mkv.torrent">MKV file
                        via BitTorrent (Modern HQ)</a> (size: 54.05 MB, length: 04:40)<br></br><a
                        href="http://tracker.tasvideos.org/wiisports-tas-golf,9holegame-tendog_512kb.mp4.torrent">MP4
                        file via BitTorrent (Compatibility)</a> (size: 58.79 MB, length: 04:40)<br></br><a
                        id="movie_3890_1_stream_0"
                        href="http://archive.org/download/Wiisports-tas-golf9holegame-tendog/wiisports-tas-golf,9holegame-tendog.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_3890_1_stream_1"
                        href="http://archive.org/download/Wiisports-tas-golf9holegame-tendog/wiisports-tas-golf,9holegame-tendog_512kb.mp4"
                        rel="nofollow">Mirror archive.org (MP4 Compatibility)</a><br></br><a id="movie_3890_1_stream_2"
                        href="http://www.youtube.com/watch?v=RBOQMY5YhbU" rel="nofollow">Watch on
                        (www.youtube.com)</a><br></br><a href="http://tasvideos.org/6197S.html" rel="nofollow">Submission
                        #6197</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/20684">Discuss this
                        movie</a><br></br>Rating: 6.5 <a href="http://tasvideos.org/rating.exe/3890/details">(8
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_3890() {
                            var e = document.getElementById("rateform_3890");
                            e.innerHTML = '<form action="/rating.exe/my/3890" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/3890M.html">View Publication</a></td>
                <td style={{height:1 + "%", width:30+ "%" ,verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C9045Y.html">Genre: Sport</a><br></br></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style ={{verticalAlign:"top"}}>Bundled with the Wii console in North America and Europe,
                    <em>Wii Sports</em> is a collection of sports games to showcase the Wii Remote. It features
                    golf, tennis, boxing, bowling and baseball.
                    <p>In this run, tendog plays through the 9-hole course (which consists
                        of all Beginner, Intermediate and Expert holes, each being 3 holes long)
                        in record time.
                    </p>
                </td>
            </tr>
    ...
    <script type="text/javascript">
        prepareStreaming("3890_1", false);
    </script>

    <a id="M2089_1"></a>
    <table className="item" id="movie_2089_1_table">
        <tbody>
            <tr>
                <td rowSpan={4} className="shot" style={{width:320 + "px", verticalAlign:"top"}}>
                    <div id="movie_2089_1_image"><img title="Gooey constructions" alt=""
                            src={require("./assets/images/2089M.jpg")} width="384" height="216"/><br></br>
                    </div>
                    <div id="movie_2089_1_streaming">Watch now using:<br></br><img
                            src={require("./assets/images/stream_archiveorg.png")} alt="Archive.org"
                            style={{cursor: "pointer"}}/><img
                            src={require("./assets/images/stream_youtube.png")} alt="YouTube"
                            style={{cursor: "pointer"}}/></div>
                ...
                <th style={{height:1+ "%"}} colSpan={2}><a href="http://tasvideos.org/Moons"><img title="Tier: Moons"
                            ...
                            href="http://tasvideos.org/FastestCompletion"><img title="Fastest Completion"
                                alt="[Fastest Completion]"
                                src={require("./assets/images/fastest-completion.png")} width="18"
                                height="18"/></a></span><span title="Movie #2089">Wii World of Goo</span><span
                        className="thin" title="World Of Goo-WiiWare.wad"> (USA)</span> in 31:30.88 by STBM.</th>
            </tr>
            <tr>
                <td style={{height:1 + "%",verticalAlign:"top"}} className="misc" ><a
                        href="http://tasvideos.org/movies/dtm/stbm-worldofgoo.zip">Dolphin movie (.dtm)</a> (date:
                    2012-08-15)<br></br><a href="http://tracker.tasvideos.org/worldofgoo-tas-stbm.mkv.torrent">MKV file
                        via BitTorrent</a> (size: 190.43 MB, length: 35:44)<br></br><a
                        href="http://tracker.tasvideos.org/worldofgoo-tas-stbm_10bit444.mkv.torrent">MKV file via
                        BitTorrent (Modern HQ)</a> (size: 178.78 MB, length: 35:44)<br></br><a id="movie_2089_1_stream_0"
                        href="http://archive.org/download/WiiWorldOfGooIn3130.88ByStbm/worldofgoo-tas-stbm.mkv"
                        rel="nofollow">Mirror archive.org</a><br></br><a id=""
                        href="http://archive.org/download/WiiWorldOfGooIn3130.88ByStbm/worldofgoo-tas-stbm_10bit444.mkv"
                        rel="nofollow">Mirror archive.org (MKV Modern HQ)</a><br></br><a id="movie_2089_1_stream_1"
                        href="http://youtube.com/watch?v=ucr3YpJPaR8" rel="nofollow">Watch on
                        (youtube.com)</a><br></br><a href="http://tasvideos.org/3670S.html" rel="nofollow">Submission
                        #3670</a> — Author's comments<br></br><a href="http://tasvideos.org/forum/t/13157">Discuss this
                        movie</a><br></br>Rating: 6.7 <a href="http://tasvideos.org/rating.exe/2089/details">(20
                        votes)</a>
                    {/* <script type="text/javascript">function rateform_2089() {
                            var e = document.getElementById("rateform_2089");
                            e.innerHTML = '<form action="/rating.exe/my/2089" method="post" target="_blank"><tr><th colSpan="3">Your votes:</th></tr><br></br><tr><td className="misc" style="width:30%">The entertainment value of this movie: </td><td className="misc" colSpan="2"><select name="s336fdcf7d540e4b430a890b63da159c9"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="d336fdcf7d540e4b430a890b63da159c9"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr><br></br><tr><td className="misc" style="width:30%">The technical quality of this movie: </td><td className="misc" colSpan="2"><select name="sb3f6d9ddb22b443e40f53e50f0726c7f"><option value="-1" selected={true}>-</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>.<select name="db3f6d9ddb22b443e40f53e50f0726c7f"><option value="0" selected={true}>0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></td></tr></tbody></table><br></br><input type="submit" value="Send data"></form>'
                        }
                    </script> */}
                    <br></br><a href="http://tasvideos.org/2089M.html">View Publication</a></td>
                <td style={{height:1 + "%",width:30+ "%",verticalAlign:"top"}} className="misc" >- <a
                        href="http://tasvideos.org/Movies-C9020Y.html">Genre: Puzzle</a><br></br><a
                        href="http://tasvideos.org/Awards/2012.html#tas_first_12"><img
                            src="TASVideos%20movies%20Wii%20only_files/tas_first_12.png"
                            alt="Award - First edition TAS of 2012" title="Award - First edition TAS of 2012"
                            style={{border:"none",height:40 + "px"}}/></a></td>
            </tr>
            <tr>
                <td colSpan={2} className="blah" style ={{verticalAlign:"top"}}><em>World of Goo</em>
                    is a physics-based puzzle game for the Wii. You create structures out
                    of goo and usher around goo balls with them. The gameplay can be pretty
                    interesting, with quite a few different kinds of goo to play with and
                    some interesting puzzle physics to go with it.
                    <p>First time author STBM uses careful planning and some interesting glitches to complete levels
                        in the blink of an eye. See the <a title="#3670: STBM's Wii World of Goo in 31:30.88"
                            href="http://tasvideos.org/3670S.html">author's notes</a> for a full explanation of the

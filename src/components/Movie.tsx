...
class Movie extends React.Component<IMovieProps, IMovieState> {
  constructor(props: IMovieProps) {
    super(props);
    this.state = { collapsed: true, highlighted: false, hidden: false,linksCollapsed:true,collapsedText:"More..."};
  }
  public toggleCollapse = () => {
    this.setState({ collapsed: !!!this.state.collapsed , collapsedText:this.state.collapsed?"Less":"More..."});
  ...
  public render() {
    ...
    return (
      <div className="border bg-light border-dark rounded text-dark mb-2">
            ...
            <tr>
              <td className="text-justify" rowSpan={2}>
                ...
                <div className="container">
                  ...
                  height="315"
                  src={
                    youtubeEmbedLinkBase + this.props.youtubeLinks.slice(-11)
                  }
                  frameBorder="0"
                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col">
                        ...
                        <Dropdown isOpen={!!!this.state.linksCollapsed} toggle={this.toggleLinksCollapse} >
